...
do{
    ...
    switch (opcion){
        ...
        case 6:
        if (cuentas.length != 0){    
            let massaldo = parseInt(prompt("Ingrese dinero en pesos:"))
            cuentas[indiceCuenta].saldopesosarg = cuentas[indiceCuenta].saldopesosarg + massaldo
            alert("su nuevo saldo es : " + cuentas[indiceCuenta].saldopesosarg)
        }
        else{
            alert("Debe crear una cuenta primero")
        }
